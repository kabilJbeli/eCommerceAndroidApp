...
import com.example.ecommerceandroidapp.databinding.OrderListItemBinding;
...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder>{
    ...
    private OrderAdapterOnClickHandler clickHandler;
    ...
    public OrderAdapter(Context mContext, List<Order> orderList, OrderAdapterOnClickHandler clickHandler) {
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, int position) {
        ...
        holder.binding.productPrice.setText(formattedPrice + " TDN");
